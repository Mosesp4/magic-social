...
const TestimonialsSection: React.FC = () => {
  const testimonials: Testimonial[] = [
    ...
    },
    {
      id: 2,
      name: 'Chinedu Eze',
      handle: '@chinedurepairs',
      business: "Chinedu's Auto Repair",
    ...
    },
    {
      id: 3,
      name: 'Amina Bello',
      handle: '@aminasflorals',
      business: "Amina's Flower Boutique",
    ...
    },
    {
      ...
      name: 'Tunde Balogun',
      handle: '@tundefitness',
      business: "Balogun Fitness Studio",
    ...
    },
    {
      id: 5,
      name: 'Funke Adeyemi',
      handle: '@funkeconsulting',
      business: "Adeyemi Business Consulting",
    ...
    },
    {
      id: 6,
      name: 'Emeka Nwosu',
      handle: '@emekacontracting',
      business: "Nwosu Home Improvements",
    ...
    },
    {
      ...
      name: 'Bola Ojo',
      handle: '@bolasdiner',
      business: "Bola's Neighborhood Diner",
